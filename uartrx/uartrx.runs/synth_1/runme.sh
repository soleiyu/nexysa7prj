...
HD_PWD='/home/kawamata/git/nexysa7prj/uartrx/uartrx.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uartrx_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uartrx_top.tcl
