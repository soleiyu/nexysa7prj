...
HD_PWD='/home/kawamata/git/nexysa7prj/japari/jagari/jagari.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log beeper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source beeper.tcl
